# Source to MATPOWER file from https://github.com/GridMod/RTS-GMLC/blob/master/RTS_Data/FormattedData/MATPOWER/script.py
# Used for reference only, i.e. to build the mat_to_source script
