    ...
    for side in [1,2]:
        ...
        if special:
            par_attribs = [
                ...
                {'type':'DOUBLE', 'name':'distance_tZone_0_', 'value':str(0.3 - CB_max_error)},  # CB time error modelled in timer for simplicity (see TODO below)
                {'type':'DOUBLE', 'name':'distance_tZone_1_', 'value':str(0.3 + CB_max_error)},
                {'type':'DOUBLE', 'name':'distance_tZone_2_', 'value':str(0.6 + CB_max_error)},
                {'type':'DOUBLE', 'name':'distance_tZone_3_', 'value':str(0.6 - CB_max_error)},
                ...
                {'type':'DOUBLE', 'name':'distance_CircuitBreakerTime', 'value': str(CB_time)},  # TODO: double protections to have different CB times
        ...
        if WITH_HIDDEN_FAILURES:
            ...
            par_attribs = [
                ...
                {'type':'DOUBLE', 'name':'distance_BlinderAnglePu', 'value': str(blinder_angle)},
                {'type':'DOUBLE', 'name':'distance_BlinderReachPu', 'value': str(blinder_reach)},
                {'type':'DOUBLE', 'name':'distance_CircuitBreakerTime', 'value': str(CB_time)},
